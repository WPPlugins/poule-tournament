...
<?php do_action('poule_before_own_score'); ?>
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th colspan="2" class="text-right col-lg-3"><?php _e('Country 1', 'poule-tournament') ?></th>
                        <th class="text-right col-lg-1"><?php _e('Score', 'poule-tournament') ?></th>
                        <th class="text-center">-</th>
                        <th class="col-lg-1"><?php _e('Score', 'poule-tournament') ?></th>
                        <th colspan="2" class="col-lg-3"><?php _e('Country 2', 'poule-tournament') ?></th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group <?php //echo $error[$match['row']]['score1']; ?> <?php //echo $match['visual_check_1']; ?>">
                        ...
                        <td>
                            <div class="form-group <?php //echo $error[$match['row']]['score1']; ?> <?php //echo $match['visual_check_1']; ?>">
                                <input type="number" min="0" max="20" class="inputscore form-control text-right " <?php echo $match['readonly'] ?> name="score[<?php echo $match['row'] ?>][score2]" id="score_<?php echo $match['row'] ?>_2" value="<?php echo $match['score2'] ?>" match_id="<?php echo $match['row'] ?>" number="2"/>
                            </div>
                        </td>
                        <td class="col-lg-3">
                    ...
                    <tr id="hidden_<?php echo $match['row'] ?>" <?php echo $match['hidden']; ?>>
                        ...
                        <td colspan="3">
                            <div class="text-center">
                                <select name="score[<?php echo $match['row'] ?>][penalty]" class="form-control" <?php echo $match['readonly'] ?> <?php // echo $match['visual_check_penalty']; ?>>
                                    <option></option>
